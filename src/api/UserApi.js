...
export const registerUser = async (username, password, nickname, role, douban_user, qywx_user, overseerr_user, pushdeer_key, bark_url) => {
...
export const updateUser = async (uid, username, nickname, new_password, role, douban_user, qywx_user, overseerr_user, pushdeer_key, bark_url) => {
